...
# -*- coding: utf-8 -*-
"""
us-jazz-history: MusicBrainzの参加ミュージシャン(パフォーマー)情報を取得し、
...
アーティスト・リレーション(演奏者・ヴォーカル・指揮者など)を集計する。

MusicBrainzはコミュニティ編集のデータベースのため、リレーション情報が
登録されていないリリースも多い。見つからない場合は personnel を null のまま
にし、存在しないデータを捏造しない(名盤ガイドの手入力データとは異なり、
このスクリプトは実在するクレジット情報のみを反映する)。
...
INSTRUMENT_ABBR = {
    ...
    "trombone": "tb", "bass trombone": "b-tb", "valve trombone": "v-tb",
    ...
    "keyboard": "kbd", "synthesizer": "syn", "celesta": "celesta",
    "guitar": "g", "electric guitar": "g", "acoustic guitar": "ag",
    "banjo": "banjo", "ukulele": "uke",
    "double bass": "b", "bass guitar": "eb", "electric bass guitar": "eb",
    "drums (drum set)": "ds", "drum kit": "ds", "drums": "ds",
    "percussion": "perc", "vibraphone": "vib", "marimba": "marimba",
    "conductor": "cond", "arranger": "arr",
...
def main():
    parser = argparse.ArgumentParser(description="us-jazz-history 参加ミュージシャン取得スクリプト")
